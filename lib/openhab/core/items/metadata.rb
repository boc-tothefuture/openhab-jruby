    ...
    module Items
      ...
      module Metadata
        ...
        class NamespaceAccessor
          ...
          #
          # @return [MetadataItem, nil], or nil if the namespace doesn't exist
          #
          def [](namespace)
          ...
          #
          # @param value [MetadataItem,
          #   org.openhab.core.items.Metadata,
          #   Array[String, Hash<String, Object>]]
          #
          # @return [MetadataItem]
          #
          def []=(namespace, value)
          ...
          #
          # @return [MetadataItem], or nil if the namespace doesn't exist
          #
          def dig(key, *keys)
