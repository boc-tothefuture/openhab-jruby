...
RSpec.describe OpenHAB::DSL::Rules::Triggers::Changed do
  ...
  def self.test_changed_trigger( # rubocop:disable Metrics
    item = 'Alarm_Mode1',
    initial_state: nil,
    new_state: 9,
    from: nil,
  ...
  describe 'duration' do
    ...
    def self.test_changed_trigger(item = 'Alarm_Mode1', # rubocop:disable Metrics
                                  initial_state: 8,
                                  new_state: 14,
                                  duration: 5.seconds,
    ...
    context 'with a numeric group item' do # rubocop:disable RSpec/EmptyExampleGroup examples are dynamically generated
      ...
      def self.test_changed_trigger(item, new_state: 14, expect_triggered: 'Alarm_Mode4', **kwargs) # rubocop:disable Metrics
    ...
    context 'with a switch group item' do # rubocop:disable RSpec/EmptyExampleGroup examples are dynamically generated
      ...
      def self.test_changed_trigger(item, # rubocop:disable Metrics
                                    initial_state: OFF,
                                    new_state: ON,
